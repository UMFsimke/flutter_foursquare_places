...
import 'generated_app_localizations_sr.dart';
...
abstract class AppLocalizations {
  ...
  /// Message describing how many times user pushed increment button
  ///
  /// In en, this message translates to:
  /// **'You have pushed the button {counter} times'**
  String counterMessage({required int counter});

  /// Title for the increment counter action
  ///
  /// In en, this message translates to:
  /// **'Increment'**
  String get actionIncrement;

  /// Episodes watched last night
  ///
  /// In en, this message translates to:
  /// **'{numberOfEpisodesWatched, plural, =0{I did not watch any episode last night} =1{I did watch one episode} other{I did watch {numberOfEpisodesWatched} episodes last night}}'**
  String watchedEpisodes({required int numberOfEpisodesWatched});

  /// Various pronouns based on gender
  ///
  /// In en, this message translates to:
